...
public class AccountServiceImpl implements AccountService {
	 ...
	 * 
	 * } else if (accountType.equalsIgnoreCase("Savings")) { SavingsAccount
	 * savingsAccount = user.getSavingsAccount();
	 * savingsAccount.setAccountBalance(savingsAccount.getAccountBalance().add(new
	 * BigDecimal(amount))); savingsAccountDao.save(savingsAccount);
	 * 
	 * Date date = new Date(); SavingsTransaction savingsTransaction = new
	 * SavingsTransaction(date, "Deposit to savings Account", "Account", "Finished",
	 ...
	 * primaryAccount.getAccountBalance(), primaryAccount);
	 * transactionService.savePrimaryWithdrawTransaction(primaryTransaction); } else
